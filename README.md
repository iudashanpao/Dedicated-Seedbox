...
[中文Readme](https://github.com/iudashanpao/Dedicated-Seedbox/blob/main/README-zh.md)
...
## Usage
### Install.sh
`bash <(wget -qO- https://raw.githubusercontent.com/iudashanpao/Dedicated-Seedbox/main/Install.sh) <username> <password> <Cache Size(unit:GiB)>`
